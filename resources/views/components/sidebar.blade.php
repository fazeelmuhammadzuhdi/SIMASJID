     ...
     <ul class="menu">
         ...
         <li class="sidebar-item has-sub {{ Route::is('masjid.*') || Route::is('kas.*') ? 'active open' : '' }}">
             ...
             <ul class="submenu {{ Route::is('masjid.*') ? 'menu-open' : '' }}">
                 ...
                 <li class="submenu-item {{ Route::is('kategori.*') ? 'active open' : '' }}">
                     <a href="{{ route('kategori.index') }}">Kategori Informasi</a>
                 </li>
                 <li class="submenu-item {{ Route::is('informasi.*') ? 'active open' : '' }}">
         ...
         <li class="sidebar-item">
             <a href="{{ route('userprofile.edit', 0) }}" class='sidebar-link'>
